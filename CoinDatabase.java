...
public class CoinDatabase {
    ...
    public static void add2EuroCommemorativeCoins(Database database) {
        ...
        database.add2EuroCoin("cy", SpecialEuroCoin.COMMON_TITLE_2CC_2, 2020, R.drawable.twoeuro_comm_2020_cy_2, R.string.twoeuro_comm_2020_cy_2_title, R.string.twoeuro_comm_2020_cy_2_desc, R.string.twoeuro_comm_2020_cy_2_volume, R.string.twoeuro_comm_2020_cy_2_date, R.string.twoeuro_comm_2020_cy_2_short_title, false);
