...
public class CoinDatabase {
    ...
    public static void add2EuroCommemorativeCoins(Database database) {
        ...
        database.add2EuroCoin("ee", SpecialEuroCoin.COMMON_TITLE_2CC, 2019, R.drawable.euro_muenze_rs_common_2euro, R.string.twoeuro_comm_2019_ee_title, R.string.twoeuro_comm_2019_ee_desc, R.string.twoeuro_comm_2019_ee_volume, R.string.twoeuro_comm_2019_ee_date, R.string.twoeuro_comm_2019_ee_short_title, false);
