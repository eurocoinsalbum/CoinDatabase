...
public class CoinDatabase {
    ...
    public static void add2EuroCommemorativeCoins(Database database) {
        ...
        database.add2EuroCoin("va", SpecialEuroCoin.COMMON_TITLE_2CC_2, 2019, R.drawable.twoeuro_comm_2019_va, R.string.twoeuro_comm_2019_va_2_title, R.string.twoeuro_comm_2019_va_2_desc, R.string.twoeuro_comm_2019_va_2_volume, R.string.twoeuro_comm_2019_va_2_date, R.string.twoeuro_comm_2019_va_2_short_title, false);
